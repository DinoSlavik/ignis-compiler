...
// QUES: Батьківський клас. Доступ до батьківського класу відбувається за допомогою ключового слова `__prime__`, 
котрий доступний лише у методах класу та за необхідності може бути переназваний через присвоєння. 
Проблема лише у тому, що ми відмовилися від "Батьківства" на користь трейтів, і тому виникає питання: 
а де використати `__prime__`, якщо ну дуже хочеться? 
